export function TestSearch(){// Get User objects by username, using user authentication
...
/*If you cannot run some of the code here are some troubleshooting tips:
 npm config set legacy-peer-deps true
 npm i
 
 these are in order to run npm install got, needle and others
 */
